    ...
    <div className="resume">
      ...
      <div className="timeline">
        ...
        <div className="timeline-column">
          ...
          <div className="timeline-item reveal-item" ref={addItemRef}>
            <h2>SUMMARY</h2>
            <h3>JAYAMURUGAN V</h3>
            <p>
        ...
        <div className="timeline-column">
          ...
          <div className="timeline-item reveal-item" ref={addItemRef}>
            ...
            <ul>
              ...
              <p>Dressora is a responsive clothing website built using React, HTML, and CSS, offering a user-friendly shopping experience with product listings and category navigation. It uses Firebase API for data storage and includes interactive features to enhance user engagement.</p>
              ...
              <p>A user-friendly contact management application built with React, HTML, and CSS that allows users to add, view, edit, and delete contact details with a simple, responsive, and organized interface.</p>
      ...
      <button className="resume-top-btn" onClick={() => window.scrollTo({ top: 0, behavior: "smooth" })}>
        Back to top
      </button>
